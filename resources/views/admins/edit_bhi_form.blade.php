                        ...
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin">
                            <div class="card card-rounded">
                              <div class="card">
                                <div class="card-body">
                                  <h4 class="card-title">@lang('titles.edit_bhi')</h4>
                                   @php
                                      $all = (new BhiController())->GetBhiById($id);
                                    @endphp
                                    @foreach($all as $all)
                                        <form class="forms-sample" action="/editbhi" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="BHI of of 12/03/2023" name="title" value="{{$all->name_file}}" required>
                                              </div>
                                            </div>
                                            <div class="form-group row">
