      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">@lang('messages.greeting_home') <span class="text-black fw-bold">@yield('full_name', 'John Doe')</span></h1>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
               ...
               <form method="post" action="user_customer_profile">
                @csrf
                  @if (isset(auth()->user()->first_lastname))
              ...
              <form method="post" action="logout_user">
                @csrf
                <button type="submit" class="dropdown-item" ><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>@lang('actions.Sign_out')</button>
              </form>
            </div>
          </li>
        </ul>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            @if(isset(auth()->user()->first_lastname))
               <a class="nav-link" href="customer_welcome"><!--CREER UNE CONDITION ICI POUR AFFICHER CE QU'IL FAUT AFFICHER-->
                <i class="mdi mdi-grid-large menu-icon"></i>
              <span class="menu-title">@lang('menu_user.home')</span>
              </a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="bhi_download">
              <i class="menu-icon  mdi mdi-briefcase-check "></i>
              <span class="menu-title">@lang('menu_user.BHI')</span>
            </a>
          </li>
           @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright © 2024 Æneas West Africa</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
